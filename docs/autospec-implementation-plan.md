...
- Add Architect Agent and Frontend Agent.
- Add human-in-the-loop editing after PRD generation.
- Add SSE or WebSocket real-time streaming.
- Add PDF export.
- Add prompt version management table.
- Add failed-node retry and local regeneration.
- Add generated React page skeleton artifacts.
