...
public class ProjectController {
    ...
    public GenerateProjectResponse generate(@PathVariable Long projectId) {
    ...
    public ReviewResponse review(@PathVariable Long projectId) {
