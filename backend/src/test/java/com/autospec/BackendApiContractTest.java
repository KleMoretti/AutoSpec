...
class BackendApiContractTest {
    ...
    void packagedOpenApiContractDocumentsCoreBackendEndpointsAndErrorModel() throws Exception {
        ...
        assertThat(contract)
                ...
                .contains("/api/projects/dashboard")
                ...
                .contains("/api/workflow-approvals/{approvalId}/decide")
                .contains("/api/workflows/{workflowKey}/versions")
                .contains("  /api/workflow-runs:\n")
                .contains("  /api/workflow-runs/{runId}:\n")
                ...
                .contains("/api/projects/{projectId}/workflow-runs/page")
                .contains("/api/projects/{projectId}/workflow-runs/{runId}/cancel")
                .contains("/api/workflow-runs/{runId}/nodes/page")
                ...
                .contains("/api/projects/{projectId}/artifacts/{artifactId}/diff")
                .contains("/api/projects/{projectId}/artifacts/{artifactId}/restore")
                ...
                .contains("ApprovalDecisionRequest")
                .contains("KnowledgeSourceResponse")
                .contains("CodeGenerationResponse")
                .contains("CodeGenerationJobResponse")
                .contains("DeliveryReadinessResponse")
                .contains("ArtifactTraceGraphResponse")
                .contains("verificationJson")
                ...
                .contains("ModelUsageResponse")
                .contains("WorkflowReplayRequest")
                .contains("WorkflowVersionResponse")
                .contains("WorkflowNodeRunCursorPage")
                .contains("WorkflowNodeRunResponse")
                .contains("AuditEventResponse")
                .contains("ExternalCallLogResponse")
                .contains("ModelInvocationResponse")
                .contains("ModelInvocationCursorPage")
                .contains("AgentEventResponse")
                .contains("AgentEventCursorPage")
                .contains("ReviewResponse")
                .contains("ReviewIssueUpdateRequest")
                .contains("ProjectDashboardItemResponse")
                .contains("ArtifactDiffResponse")
                .contains("ArtifactRestoreRequest")
                ...
                .contains("WorkflowRunCursorPage")
