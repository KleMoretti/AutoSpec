...
def generate_v2(request: GenerateRequest) -> dict:
    return v2_response(run_v2_workflow(request.requirement))
...
def generate_v2_continue(request: ContinueV2Request) -> dict:
    ...
    return v2_response(run_v2_continue_workflow(request.requirement, prd))
